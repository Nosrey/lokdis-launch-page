...
const translations = {
  es: {
    ...
    heroSubtitle: 'Una app para explorar la realidad de rincones de todo el mundo, sin filtros ni ediciones 🌍 🇪🇸',
    heroDescription: 'Busca el lugar que quieres ver, solicita un video o una foto a alguien que esté en él y... ¡mira desde tu teléfono!',
  ...
  en: {
    ...
    heroSubtitle: 'An app to explore the reality of places around the world, without filters or edits 🌍 🇺🇸',
    heroDescription: 'Find the place you want to see, request a video or photo from someone who is there and... watch from your phone!',
